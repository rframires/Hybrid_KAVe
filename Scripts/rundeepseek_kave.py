...
output_csv_sqli_safe = "../output/results_sqli_safe_deepseek_kave.csv"
analyze_folder(folder_path_sqli_safe, output_csv_sqli_safe, "SQLi")

folder_path_sqli_unsafe = "../Samples/SQLi_Unsafe/"
output_csv_sqli_unsafe = "../output/results_sqli_unsafe_deepseek_kave.csv"
...
output_csv_xss_safe = "../output/results_xss_safe_deepseek_kave.csv"
analyze_folder(folder_path_xss_safe, output_csv_xss_safe, "XSS")

folder_path_xss_unsafe = "../Samples/XSS_Unsafe/"
output_csv_xss_unsafe = "../output/results_xss_unsafe_deepseek_kave.csv"
