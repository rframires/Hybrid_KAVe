...
output_csv_sqli_unsafe = "results_sqli_baseline_unsafe.csv"
analyze_folder(folder_path_sqli_unsafe, output_csv_sqli_unsafe, "SQLi")

folder_path_sqli_safe = "Samples/SQLi_Safe/"
output_csv_sqli_safe = "results_sqli_baseline_safe.csv"
...
output_csv_xss_unsafe = "results_xss_baseline_unsafe.csv"
analyze_folder(folder_path_xss_unsafe, output_csv_xss_unsafe, "XSS")

folder_path_xss_safe = "Samples/XSS_Safe/"
output_csv_xss_safe = "results_xss_baseline_safe.csv"
